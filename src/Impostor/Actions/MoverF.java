...
public class MoverF extends SearchAction {
	@Override
    public SearchBasedAgentState execute(SearchBasedAgentState s) {
		ImpostorAgentState impostorState = (ImpostorAgentState) s;
		
		int siguienteSala = impostorState.getSalasAdyacentes()[5];
		//Solo puede realizar esta acción si hay una sexta sala a la que ir
		if(siguienteSala >= 0) {
